    ...
    render(){
        ...
        return(
            <div>
                ...
                <br/>
                <select className="form-control" onChange={event => this.setState({currency: event.target.value})}>
